...
%%----------------------------------------
\title{Lightweight Real-Time Data Monitoring}
...
\supervisor{Supervisor}{Prof. André Monteiro de Oliveira Restivo}

\supervisor{Second Supervisor}{Prof. Pedro Manuel Pinto Ribeiro}

\supervisor{Company Supervisor}{Eng. Pedro Cardoso Silva}
...
\include{chapters/problem-pdis}
\include{chapters/conclusion-pdis}
