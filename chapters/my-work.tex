...
The sliding window histogram we use is an Exponential Moving Average (EMA) based histogram. An EMA-like histogram is essentially a collection of EMA-counts as described in Section \ref{sec:emas}.
